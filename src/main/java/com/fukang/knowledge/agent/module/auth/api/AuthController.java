package com.fukang.knowledge.agent.module.auth.api;

import com.fukang.knowledge.agent.module.auth.api.dto.LoginReq;
import com.fukang.knowledge.agent.module.auth.api.dto.LoginResp;
import com.fukang.knowledge.agent.module.auth.api.dto.RegisterReq;
import com.fukang.knowledge.agent.module.auth.application.AuthAppService;
import com.fukang.knowledge.agent.module.auth.application.command.LoginCommand;
import com.fukang.knowledge.agent.module.auth.application.command.RegisterCommand;
import com.fukang.knowledge.agent.module.auth.application.result.LoginResult;
