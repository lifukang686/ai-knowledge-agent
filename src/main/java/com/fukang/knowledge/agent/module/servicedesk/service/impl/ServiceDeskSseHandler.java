package com.fukang.knowledge.agent.module.servicedesk.service.impl;
 ...
 */
@Slf4j
public class ServiceDeskSseHandler implements ServiceDeskStreamHandler {
    ...
    public ServiceDeskSseHandler(SseEmitter emitter) {
