...
public class ModelService {
    ...
    public Long createModelConfig(ModelConfigReq req) {
        ...
        config.setModelType(req.getModelType());
        if (req.getDefaultParams() != null && !req.getDefaultParams().isBlank()) {
            config.setDefaultParams(req.getDefaultParams());
        }
     ...
     */
    public ModelProviderEntity findDefaultProvider() {
        return providerMapper.findDefault();
    }
     ...
     * @return 指定类型的模型配置列表
     */
    public List<ModelConfigEntity> findModelsByType(ModelTypeEnum modelType) {
        return modelConfigMapper.findByType(modelType);
    }
     ...
     */
    public List<ModelConfigEntity> findModelsByProviderAndType(Long providerId, ModelTypeEnum modelType) {
        return modelConfigMapper.findByProviderAndType(providerId, modelType);
    }
    ...
    public void deleteProvider(Long id) {
        ...
        modelConfigMapper.deleteByProviderId(id);
