package com.fukang.knowledge.agent.module.knowledge.application.embedding;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fukang.knowledge.agent.module.ai.application.port.EmbeddingPort;
import com.fukang.knowledge.agent.module.model.application.ModelAppService;
import com.fukang.knowledge.agent.common.enums.ErrorCodeEnum;
import com.fukang.knowledge.agent.common.enums.ModelTypeEnum;
import com.fukang.knowledge.agent.common.exception.BaseException;
import com.fukang.knowledge.agent.module.knowledge.domain.model.EmbeddingResult;
    ...
    public EmbeddingResult embed(List<String> texts) {
        ...
        try {
            ...
            for (int batchIndex = 0; batchIndex < batches.size(); batchIndex++) {
                ...
                EmbeddingPort.BatchResult batchResult = embeddingPort.embedBatch(embeddingModel, batch, batchOffset);
