package com.fukang.knowledge.agent.module.knowledge.controller.knowledgebase;
...
public class KnowledgeBaseController {
    ...
    public Result<PageResponse<KnowledgeBaseResp>> listKnowledgeBases(
        ...
        PageResponse<KnowledgeBaseResult> pageResult =
                knowledgeBaseService.listKnowledgeBases(page, pageSize, keyword);
    ...
    public Result<KnowledgeBaseResp> getKnowledgeBase(@PathVariable("id") Long id) {
        return Result.success(toKnowledgeBaseResp(knowledgeBaseService.getKnowledgeBase(id)));
    }
    ...
    private KnowledgeBaseResp toKnowledgeBaseResp(KnowledgeBaseResult result) {
        return new KnowledgeBaseResp(result.getId(), result.getName(), result.getDescription(),
                result.getDocumentCount(), result.getStatus(), result.getCreateTime(), result.getUpdateTime());
    }
}
